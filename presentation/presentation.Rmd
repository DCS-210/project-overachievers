...
.pull-right[
```{r plotting-linear-regression-nonwestern, echo = FALSE, warning=FALSE, out.width = "100%"} 
...
.pull-right[
```{r plotting-linear-regression-EU, echo = FALSE, warning=FALSE, out.width = "100%"}
...
.pull-right[
```{r plotting-linear-regression-nonEU, echo = FALSE, warning=FALSE, out.width = "100%"}
...
.pull-center[
```{r finding-GDP-healthXP-in-Europe-2015, echo=FALSE, warning=FALSE, fig.align = 'center', out.width = 750}
drug_spending %>%
...
.pull-left[
```{r plotting-with-line-of-best-fit, echo = FALSE, warning=FALSE, out.width = "100%"}
european_combined %>%
