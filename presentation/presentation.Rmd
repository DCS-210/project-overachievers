...
.pull-right[
```{r plotting-linear-regression-line, echo= FALSE, out.width = "100%", warning= FALSE, message= FALSE}
...
.pull-right[
```{r plotting-linear-regression-nonwestern, echo = FALSE, warning=FALSE, message = FALSE out.width = "100%"} 
...
.pull-right[
```{r plotting-linear-regression-EU, echo = FALSE, warning=FALSE, message= FALSE, out.width = "100%"}
...
.pull-right[
```{r plotting-linear-regression-nonEU, echo = FALSE, warning=FALSE, message= FALSE, out.width = "100%"}
...
.pull-center[
```{r finding-GDP-healthXP-in-Europe-2015, echo=FALSE, warning=FALSE, message=FALSE,  fig.align = 'center', out.width = 750}
drug_spending %>%
...
.pull-left[
```{r plotting-with-line-of-best-fit, echo = FALSE, warning=FALSE, message= FALSE, out.width = "100%"}
european_combined %>%
...
.pull-left[
```{r plotting-residuals, echo=FALSE, message = FALSE, warning=FALSE, out.height="30%", out.width="100%"}
...
.pull-left[
```{r, echo=FALSE, out.width=1050, fig.align='center', fig.cap="A map of Europe containing the schengen countries, EU and non-EU countries from www.polgeonow.com."}
